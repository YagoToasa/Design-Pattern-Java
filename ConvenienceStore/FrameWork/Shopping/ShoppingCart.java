...
public class ShoppingCart {
    ...
    private FoodPrototype[] foods;                  //食品容器
    ...
    public ShoppingCart(int maxSize) throws Exception {
        if (maxSize > 0) {
            ...
            this.foods = new FoodPrototype[maxSize];
            this.currentSize = 0;
        } else {
     ...
     * @return: boolean
     */
    public boolean addFood(FoodPrototype food) {
     ...
     * @return: boolean
     */
    public boolean removeFood(FoodPrototype food) {
     ...
     */
    public FoodPrototype getFoodByIndex(int index) {
        return foods[index];
    }
